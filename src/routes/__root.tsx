...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "RailGo — Modern Train Ticket Booking" },
      { name: "description", content: "Book Indian railway tickets in seconds. Search trains, pick seats, and manage your journeys." },
      { property: "og:title", content: "RailGo — Modern Train Ticket Booking" },
      { property: "og:description", content: "Book Indian railway tickets in seconds." },
